...
const Testimonials = () => {
  return (
    <div className="container-sm mx-auto flex flex-col pt-0 lg:pt-20 lg:flex-row ">
      {/* Testimonial Text */}
      <div className="mx-auto text-center lg:text-start py-4 lg:px-8 w-full max-w-[500px] lg:max-w-full lg:w-1/2">
        <h3 className=" text-bg lg:text-3xl py-10">
          HERE'S WHAT PEOPLE ARE SAYING
        </h3>
        <p className="font-semibold xl:text-2xl lg:text-xl">
          Whether you're managing a team of five or scaling a global enterprise,
          ...
          few of the reasons why professionals around the world choose us every
          day. Join the movement and discover what it means to work smarter, not
          harder.
        </p>
      </div>
      {/* Cards */}
      <Swiper
        ...
        loop
        autoplay={{ delay: 5000 }}
        className=" h-[400px] w-full max-w-[500px] lg:max-w-full lg:w-1/2 gap-2 mt-6"
      >
